...
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton, InlineQueryResultArticle, InputTextMessageContent, Message
import shutil
import requests
import json
import os
...
bot_token = "5957089360:AAH8fzbYxyZN1zGXkCJCV2cmWGn8P5K6Px0"
workers = int(1)
api = 26257824
hash = "fcd5ae25cf2c155671549db115710769"
chnnl = "https://t.me/yeahidontkno"
BOT_URL = "https://t.me/eduneascorbinbot"
app = Client("Edubot", bot_token=bot_token, api_id=api, api_hash=hash, workers=workers)
...
def tiktok_dl(client: Client, message: Message):
